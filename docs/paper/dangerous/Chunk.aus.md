...
[20:14] (extern: com.lehman.aussomcraft.paper.gen.dangerous.ChunkShim) **extends: object** 
...
- **addPluginChunkTicket** (`Plugin`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/Chunk.html#addPluginChunkTicket(org.bukkit.plugin.Plugin)
...
- **removePluginChunkTicket** (`Plugin`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/Chunk.html#removePluginChunkTicket(org.bukkit.plugin.Plugin)
