...
[15:14] (extern: com.lehman.aussomcraft.paper.gen.dangerous.CommandShim) **extends: object** 
...
- **register** (`CommandMap`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/Command.html#register(org.bukkit.command.CommandMap)
...
- **unregister** (`CommandMap`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/Command.html#unregister(org.bukkit.command.CommandMap)
