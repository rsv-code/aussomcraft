...
[19:14] (extern: com.lehman.aussomcraft.paper.gen.dangerous.MessageCommandSenderShim) **extends: object** 
...
- **hasPermission\_perm** (`Perm`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/MessageCommandSender.html#hasPermission(org.bukkit.permissions.Permission)
...
- **isPermissionSet\_perm** (`Perm`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/MessageCommandSender.html#isPermissionSet(org.bukkit.permissions.Permission)
...
- **addAttachment** (`Plugin`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/MessageCommandSender.html#addAttachment(org.bukkit.plugin.Plugin)
...
- **addAttachment** (`Plugin, Ticks`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/MessageCommandSender.html#addAttachment(org.bukkit.plugin.Plugin,int)
...
- **addAttachment** (`Plugin, Name, Value`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/MessageCommandSender.html#addAttachment(org.bukkit.plugin.Plugin,java.lang.String,boolean)
...
- **addAttachment** (`Plugin, Name, Value, Ticks`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/MessageCommandSender.html#addAttachment(org.bukkit.plugin.Plugin,java.lang.String,boolean,int)
...
- **getServer** ()
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/MessageCommandSender.html#getServer()
...
- **removeAttachment** (`Attachment`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/MessageCommandSender.html#removeAttachment(org.bukkit.permissions.PermissionAttachment)
...
- **setOp** (`Value`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/MessageCommandSender.html#setOp(boolean)
