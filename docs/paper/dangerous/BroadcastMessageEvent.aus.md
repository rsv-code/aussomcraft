...
[20:14] (extern: com.lehman.aussomcraft.paper.gen.dangerous.BroadcastMessageEventShim) **extends: object** 
...
- **callEvent** ()
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/event/server/BroadcastMessageEvent.html#callEvent()
...
- **getHandlerList** ()
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/event/server/BroadcastMessageEvent.html#getHandlerList()
...
- **getHandlers** ()
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/event/server/BroadcastMessageEvent.html#getHandlers()
