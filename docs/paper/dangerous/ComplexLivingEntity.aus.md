...
[19:14] (extern: com.lehman.aussomcraft.paper.gen.dangerous.ComplexLivingEntityShim) **extends: object** 
...
- **hasPermission\_perm** (`Perm`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/entity/ComplexLivingEntity.html#hasPermission(org.bukkit.permissions.Permission)
...
- **isPermissionSet\_perm** (`Perm`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/entity/ComplexLivingEntity.html#isPermissionSet(org.bukkit.permissions.Permission)
...
- **addAttachment** (`Plugin`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/entity/ComplexLivingEntity.html#addAttachment(org.bukkit.plugin.Plugin)
...
- **addAttachment** (`Plugin, Ticks`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/entity/ComplexLivingEntity.html#addAttachment(org.bukkit.plugin.Plugin,int)
...
- **addAttachment** (`Plugin, Name, Value`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/entity/ComplexLivingEntity.html#addAttachment(org.bukkit.plugin.Plugin,java.lang.String,boolean)
...
- **addAttachment** (`Plugin, Name, Value, Ticks`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/entity/ComplexLivingEntity.html#addAttachment(org.bukkit.plugin.Plugin,java.lang.String,boolean,int)
...
- **getScheduler** ()
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/entity/ComplexLivingEntity.html#getScheduler()
...
- **getServer** ()
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/entity/ComplexLivingEntity.html#getServer()
...
- **removeAttachment** (`Attachment`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/entity/ComplexLivingEntity.html#removeAttachment(org.bukkit.permissions.PermissionAttachment)
...
- **removeMetadata** (`MetadataKey, OwningPlugin`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/entity/ComplexLivingEntity.html#removeMetadata(java.lang.String,org.bukkit.plugin.Plugin)
...
- **setOp** (`Value`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/entity/ComplexLivingEntity.html#setOp(boolean)
