...
[20:14] (extern: com.lehman.aussomcraft.paper.gen.dangerous.BufferedCommandSenderShim) **extends: object** 
...
- **hasPermission\_perm** (`Perm`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/BufferedCommandSender.html#hasPermission(org.bukkit.permissions.Permission)
...
- **isPermissionSet\_perm** (`Perm`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/BufferedCommandSender.html#isPermissionSet(org.bukkit.permissions.Permission)
...
- **addAttachment** (`Plugin`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/BufferedCommandSender.html#addAttachment(org.bukkit.plugin.Plugin)
...
- **addAttachment** (`Plugin, Ticks`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/BufferedCommandSender.html#addAttachment(org.bukkit.plugin.Plugin,int)
...
- **addAttachment** (`Plugin, Name, Value`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/BufferedCommandSender.html#addAttachment(org.bukkit.plugin.Plugin,java.lang.String,boolean)
...
- **addAttachment** (`Plugin, Name, Value, Ticks`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/BufferedCommandSender.html#addAttachment(org.bukkit.plugin.Plugin,java.lang.String,boolean,int)
...
- **getServer** ()
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/BufferedCommandSender.html#getServer()
...
- **removeAttachment** (`Attachment`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/BufferedCommandSender.html#removeAttachment(org.bukkit.permissions.PermissionAttachment)
...
- **setOp** (`Value`)
	...
	> Paper: https://jd.papermc.io/paper/1.21.10/org/bukkit/command/BufferedCommandSender.html#setOp(boolean)
