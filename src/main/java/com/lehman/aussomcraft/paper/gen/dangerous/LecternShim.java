...
public class LecternShim extends PaperObj {
    ...
    public AussomType copy(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.Lectern self = (org.bukkit.block.Lectern) this.getObj();
            if (self == null) {
    ...
    public AussomType getPage(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.Lectern) self).getPage());
            }
    ...
    public AussomType setPage(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.Lectern) self).setPage(Marshal.argInt(args, 0));
                return new AussomNull();
            }
