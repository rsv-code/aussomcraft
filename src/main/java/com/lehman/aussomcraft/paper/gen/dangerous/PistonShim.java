...
public class PistonShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Piston self = (org.bukkit.block.data.type.Piston) this.getObj();
            if (self == null) {
    ...
    public AussomType isExtended(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Piston) self).isExtended());
            }
    ...
    public AussomType setExtended(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Piston self = (org.bukkit.block.data.type.Piston) this.getObj();
            if (self == null) {
                return Marshal.detached("setExtended");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Piston) self).setExtended(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setExtended", n);
        } catch (Throwable e) {
            return Marshal.failed("setExtended", e);
        }
    }
