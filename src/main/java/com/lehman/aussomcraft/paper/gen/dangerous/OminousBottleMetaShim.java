...
public class OminousBottleMetaShim extends PaperObj {
    ...
    public AussomType addAttributeModifier(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.inventory.meta.OminousBottleMeta self = (org.bukkit.inventory.meta.OminousBottleMeta) this.getObj();
            if (self == null) {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.inventory.meta.OminousBottleMeta) self).clone());
            }
    ...
    public AussomType getAmplifier(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.inventory.meta.OminousBottleMeta) self).getAmplifier());
            }
    ...
    public AussomType hasAmplifier(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.inventory.meta.OminousBottleMeta self = (org.bukkit.inventory.meta.OminousBottleMeta) this.getObj();
            if (self == null) {
                return Marshal.detached("hasAmplifier");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.inventory.meta.OminousBottleMeta) self).hasAmplifier());
            }
            return Marshal.wrongArity("hasAmplifier", n);
        } catch (Throwable e) {
            return Marshal.failed("hasAmplifier", e);
        }
    }
    ...
    public AussomType setAmplifier(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.inventory.meta.OminousBottleMeta self = (org.bukkit.inventory.meta.OminousBottleMeta) this.getObj();
            if (self == null) {
                return Marshal.detached("setAmplifier");
            }
            if (n == 1) {
                ((org.bukkit.inventory.meta.OminousBottleMeta) self).setAmplifier(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setAmplifier", n);
        } catch (Throwable e) {
            return Marshal.failed("setAmplifier", e);
        }
    }
