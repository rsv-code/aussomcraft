...
public class SpectralArrowShim extends PaperObj {
    ...
    public AussomType addPassenger(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.entity.SpectralArrow self = (org.bukkit.entity.SpectralArrow) this.getObj();
            if (self == null) {
    ...
    public AussomType getGlowingTicks(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.entity.SpectralArrow self = (org.bukkit.entity.SpectralArrow) this.getObj();
            if (self == null) {
                return Marshal.detached("getGlowingTicks");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.entity.SpectralArrow) self).getGlowingTicks());
            }
            return Marshal.wrongArity("getGlowingTicks", n);
        } catch (Throwable e) {
            return Marshal.failed("getGlowingTicks", e);
        }
    }
    ...
    public AussomType setGlowingTicks(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.entity.SpectralArrow self = (org.bukkit.entity.SpectralArrow) this.getObj();
            if (self == null) {
                return Marshal.detached("setGlowingTicks");
            }
            if (n == 1) {
                ((org.bukkit.entity.SpectralArrow) self).setGlowingTicks(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setGlowingTicks", n);
        } catch (Throwable e) {
            return Marshal.failed("setGlowingTicks", e);
        }
    }
