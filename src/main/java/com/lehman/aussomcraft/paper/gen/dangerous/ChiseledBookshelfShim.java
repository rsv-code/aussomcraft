...
public class ChiseledBookshelfShim extends PaperObj {
    ...
    public AussomType copy(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.ChiseledBookshelf self = (org.bukkit.block.ChiseledBookshelf) this.getObj();
            if (self == null) {
    ...
    public AussomType getInventory(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.ChiseledBookshelf) self).getInventory());
            }
    ...
    public AussomType getLastInteractedSlot(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.ChiseledBookshelf self = (org.bukkit.block.ChiseledBookshelf) this.getObj();
            if (self == null) {
                return Marshal.detached("getLastInteractedSlot");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.ChiseledBookshelf) self).getLastInteractedSlot());
            }
            return Marshal.wrongArity("getLastInteractedSlot", n);
        } catch (Throwable e) {
            return Marshal.failed("getLastInteractedSlot", e);
        }
    }
    ...
    public AussomType getSlot(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                return Marshal.wrap(env, ((org.bukkit.block.ChiseledBookshelf) self).getSlot((org.bukkit.util.Vector) Marshal.typed(args, 0, org.bukkit.util.Vector.class)));
            }
    ...
    public AussomType getSnapshotInventory(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.ChiseledBookshelf) self).getSnapshotInventory());
            }
    ...
    public AussomType setLastInteractedSlot(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.ChiseledBookshelf self = (org.bukkit.block.ChiseledBookshelf) this.getObj();
            if (self == null) {
                return Marshal.detached("setLastInteractedSlot");
            }
            if (n == 1) {
                ((org.bukkit.block.ChiseledBookshelf) self).setLastInteractedSlot(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setLastInteractedSlot", n);
        } catch (Throwable e) {
            return Marshal.failed("setLastInteractedSlot", e);
        }
    }
