...
public class EnderCrystalShim extends PaperObj {
    ...
    public AussomType addPassenger(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.entity.EnderCrystal self = (org.bukkit.entity.EnderCrystal) this.getObj();
            if (self == null) {
    ...
    public AussomType getBeamTarget(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.entity.EnderCrystal self = (org.bukkit.entity.EnderCrystal) this.getObj();
            if (self == null) {
                return Marshal.detached("getBeamTarget");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.entity.EnderCrystal) self).getBeamTarget());
            }
            return Marshal.wrongArity("getBeamTarget", n);
        } catch (Throwable e) {
            return Marshal.failed("getBeamTarget", e);
        }
    }
    ...
    public AussomType isShowingBottom(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.entity.EnderCrystal self = (org.bukkit.entity.EnderCrystal) this.getObj();
            if (self == null) {
                return Marshal.detached("isShowingBottom");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.entity.EnderCrystal) self).isShowingBottom());
            }
            return Marshal.wrongArity("isShowingBottom", n);
        } catch (Throwable e) {
            return Marshal.failed("isShowingBottom", e);
        }
    }
    ...
    public AussomType setBeamTarget(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.entity.EnderCrystal self = (org.bukkit.entity.EnderCrystal) this.getObj();
            if (self == null) {
                return Marshal.detached("setBeamTarget");
            }
            if (n == 1) {
                ((org.bukkit.entity.EnderCrystal) self).setBeamTarget((org.bukkit.Location) Marshal.typed(args, 0, org.bukkit.Location.class));
                return new AussomNull();
            }
            return Marshal.wrongArity("setBeamTarget", n);
        } catch (Throwable e) {
            return Marshal.failed("setBeamTarget", e);
        }
    }
    ...
    public AussomType setShowingBottom(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.entity.EnderCrystal self = (org.bukkit.entity.EnderCrystal) this.getObj();
            if (self == null) {
                return Marshal.detached("setShowingBottom");
            }
            if (n == 1) {
                ((org.bukkit.entity.EnderCrystal) self).setShowingBottom(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setShowingBottom", n);
        } catch (Throwable e) {
            return Marshal.failed("setShowingBottom", e);
        }
    }
