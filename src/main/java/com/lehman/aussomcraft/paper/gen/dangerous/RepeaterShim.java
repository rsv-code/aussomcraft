...
public class RepeaterShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Repeater self = (org.bukkit.block.data.type.Repeater) this.getObj();
            if (self == null) {
    ...
    public AussomType getDelay(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Repeater) self).getDelay());
            }
    ...
    public AussomType getMaximumDelay(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Repeater self = (org.bukkit.block.data.type.Repeater) this.getObj();
            if (self == null) {
                return Marshal.detached("getMaximumDelay");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Repeater) self).getMaximumDelay());
            }
            return Marshal.wrongArity("getMaximumDelay", n);
        } catch (Throwable e) {
            return Marshal.failed("getMaximumDelay", e);
        }
    }

    public AussomType getMinimumDelay(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Repeater self = (org.bukkit.block.data.type.Repeater) this.getObj();
            if (self == null) {
                return Marshal.detached("getMinimumDelay");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Repeater) self).getMinimumDelay());
            }
            return Marshal.wrongArity("getMinimumDelay", n);
        } catch (Throwable e) {
            return Marshal.failed("getMinimumDelay", e);
        }
    }
    ...
    public AussomType isLocked(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Repeater) self).isLocked());
            }
    ...
    public AussomType setDelay(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.type.Repeater) self).setDelay(Marshal.argInt(args, 0));
                return new AussomNull();
            }
    ...
    public AussomType setLocked(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.type.Repeater) self).setLocked(Marshal.argBool(args, 0));
                return new AussomNull();
            }
