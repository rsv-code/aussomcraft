...
public class TypeDaylightDetectorShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.DaylightDetector self = (org.bukkit.block.data.type.DaylightDetector) this.getObj();
            if (self == null) {
    ...
    public AussomType isInverted(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.DaylightDetector) self).isInverted());
            }
    ...
    public AussomType setInverted(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.type.DaylightDetector) self).setInverted(Marshal.argBool(args, 0));
                return new AussomNull();
            }
