...
public class CalibratedSculkSensorShim extends PaperObj {
    ...
    public AussomType copy(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.CalibratedSculkSensor self = (org.bukkit.block.CalibratedSculkSensor) this.getObj();
            if (self == null) {
    ...
    public AussomType getLastVibrationFrequency(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.CalibratedSculkSensor self = (org.bukkit.block.CalibratedSculkSensor) this.getObj();
            if (self == null) {
                return Marshal.detached("getLastVibrationFrequency");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.SculkSensor) self).getLastVibrationFrequency());
            }
            return Marshal.wrongArity("getLastVibrationFrequency", n);
        } catch (Throwable e) {
            return Marshal.failed("getLastVibrationFrequency", e);
        }
    }
    ...
    public AussomType getListenerRange(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.CalibratedSculkSensor self = (org.bukkit.block.CalibratedSculkSensor) this.getObj();
            if (self == null) {
                return Marshal.detached("getListenerRange");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.SculkSensor) self).getListenerRange());
            }
            return Marshal.wrongArity("getListenerRange", n);
        } catch (Throwable e) {
            return Marshal.failed("getListenerRange", e);
        }
    }
    ...
    public AussomType setLastVibrationFrequency(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.CalibratedSculkSensor self = (org.bukkit.block.CalibratedSculkSensor) this.getObj();
            if (self == null) {
                return Marshal.detached("setLastVibrationFrequency");
            }
            if (n == 1) {
                ((org.bukkit.block.SculkSensor) self).setLastVibrationFrequency(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setLastVibrationFrequency", n);
        } catch (Throwable e) {
            return Marshal.failed("setLastVibrationFrequency", e);
        }
    }

    public AussomType setListenerRange(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.CalibratedSculkSensor self = (org.bukkit.block.CalibratedSculkSensor) this.getObj();
            if (self == null) {
                return Marshal.detached("setListenerRange");
            }
            if (n == 1) {
                ((org.bukkit.block.SculkSensor) self).setListenerRange(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setListenerRange", n);
        } catch (Throwable e) {
            return Marshal.failed("setListenerRange", e);
        }
    }
