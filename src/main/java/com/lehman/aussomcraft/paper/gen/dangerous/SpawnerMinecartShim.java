...
public class SpawnerMinecartShim extends PaperObj {
    ...
    public AussomType addPassenger(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.entity.minecart.SpawnerMinecart self = (org.bukkit.entity.minecart.SpawnerMinecart) this.getObj();
            if (self == null) {
