...
public class RespawnAnchorShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.RespawnAnchor self = (org.bukkit.block.data.type.RespawnAnchor) this.getObj();
            if (self == null) {
    ...
    public AussomType getCharges(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.RespawnAnchor self = (org.bukkit.block.data.type.RespawnAnchor) this.getObj();
            if (self == null) {
                return Marshal.detached("getCharges");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.RespawnAnchor) self).getCharges());
            }
            return Marshal.wrongArity("getCharges", n);
        } catch (Throwable e) {
            return Marshal.failed("getCharges", e);
        }
    }
    ...
    public AussomType getMaximumCharges(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.RespawnAnchor self = (org.bukkit.block.data.type.RespawnAnchor) this.getObj();
            if (self == null) {
                return Marshal.detached("getMaximumCharges");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.RespawnAnchor) self).getMaximumCharges());
            }
            return Marshal.wrongArity("getMaximumCharges", n);
        } catch (Throwable e) {
            return Marshal.failed("getMaximumCharges", e);
        }
    }
    ...
    public AussomType setCharges(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.RespawnAnchor self = (org.bukkit.block.data.type.RespawnAnchor) this.getObj();
            if (self == null) {
                return Marshal.detached("setCharges");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.RespawnAnchor) self).setCharges(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setCharges", n);
        } catch (Throwable e) {
            return Marshal.failed("setCharges", e);
        }
    }
