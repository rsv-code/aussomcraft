...
public class DropperShim extends PaperObj {
    ...
    public AussomType canPlayerLoot(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.Dropper self = (org.bukkit.block.Dropper) this.getObj();
            if (self == null) {
    ...
    public AussomType drop(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.Dropper self = (org.bukkit.block.Dropper) this.getObj();
            if (self == null) {
                return Marshal.detached("drop");
            }
            if (n == 0) {
                ((org.bukkit.block.Dropper) self).drop();
                return new AussomNull();
            }
            return Marshal.wrongArity("drop", n);
        } catch (Throwable e) {
            return Marshal.failed("drop", e);
        }
    }
