...
public class BlockDataMetaShim extends PaperObj {
    ...
    public AussomType addAttributeModifier(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.inventory.meta.BlockDataMeta self = (org.bukkit.inventory.meta.BlockDataMeta) this.getObj();
            if (self == null) {
    ...
    public AussomType getBlockData(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                return Marshal.wrap(env, ((org.bukkit.inventory.meta.BlockDataMeta) self).getBlockData((org.bukkit.Material) Marshal.typed(args, 0, org.bukkit.Material.class)));
            }
    ...
    public AussomType hasBlockData(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.inventory.meta.BlockDataMeta self = (org.bukkit.inventory.meta.BlockDataMeta) this.getObj();
            if (self == null) {
                return Marshal.detached("hasBlockData");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.inventory.meta.BlockDataMeta) self).hasBlockData());
            }
            return Marshal.wrongArity("hasBlockData", n);
        } catch (Throwable e) {
            return Marshal.failed("hasBlockData", e);
        }
    }
    ...
    public AussomType setBlockData(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.inventory.meta.BlockDataMeta) self).setBlockData((org.bukkit.block.data.BlockData) Marshal.typed(args, 0, org.bukkit.block.data.BlockData.class));
                return new AussomNull();
            }
