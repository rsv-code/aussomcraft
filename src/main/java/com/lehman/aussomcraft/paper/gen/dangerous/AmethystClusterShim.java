...
public class AmethystClusterShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.AmethystCluster self = (org.bukkit.block.data.type.AmethystCluster) this.getObj();
            if (self == null) {
