...
public class StorageMinecartShim extends PaperObj {
    ...
    public AussomType addPassenger(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.entity.minecart.StorageMinecart self = (org.bukkit.entity.minecart.StorageMinecart) this.getObj();
            if (self == null) {
