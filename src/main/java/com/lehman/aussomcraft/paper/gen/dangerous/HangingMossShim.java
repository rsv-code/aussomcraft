...
public class HangingMossShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.HangingMoss self = (org.bukkit.block.data.type.HangingMoss) this.getObj();
            if (self == null) {
    ...
    public AussomType isTip(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.HangingMoss self = (org.bukkit.block.data.type.HangingMoss) this.getObj();
            if (self == null) {
                return Marshal.detached("isTip");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.HangingMoss) self).isTip());
            }
            return Marshal.wrongArity("isTip", n);
        } catch (Throwable e) {
            return Marshal.failed("isTip", e);
        }
    }
    ...
    public AussomType setTip(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.HangingMoss self = (org.bukkit.block.data.type.HangingMoss) this.getObj();
            if (self == null) {
                return Marshal.detached("setTip");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.HangingMoss) self).setTip(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setTip", n);
        } catch (Throwable e) {
            return Marshal.failed("setTip", e);
        }
    }
