...
public class DispenserShim extends PaperObj {
    ...
    public AussomType canPlayerLoot(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.Dispenser self = (org.bukkit.block.Dispenser) this.getObj();
            if (self == null) {
    ...
    public AussomType dispense(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.Dispenser self = (org.bukkit.block.Dispenser) this.getObj();
            if (self == null) {
                return Marshal.detached("dispense");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.Dispenser) self).dispense());
            }
            return Marshal.wrongArity("dispense", n);
        } catch (Throwable e) {
            return Marshal.failed("dispense", e);
        }
    }
    ...
    public AussomType getBlockProjectileSource(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.Dispenser self = (org.bukkit.block.Dispenser) this.getObj();
            if (self == null) {
                return Marshal.detached("getBlockProjectileSource");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.Dispenser) self).getBlockProjectileSource());
            }
            return Marshal.wrongArity("getBlockProjectileSource", n);
        } catch (Throwable e) {
            return Marshal.failed("getBlockProjectileSource", e);
        }
    }
