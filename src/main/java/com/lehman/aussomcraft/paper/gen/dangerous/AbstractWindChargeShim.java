...
public class AbstractWindChargeShim extends PaperObj {
    ...
    public AussomType addPassenger(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.entity.AbstractWindCharge self = (org.bukkit.entity.AbstractWindCharge) this.getObj();
            if (self == null) {
    ...
    public AussomType explode(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                ((org.bukkit.entity.AbstractWindCharge) self).explode();
                return new AussomNull();
            }
