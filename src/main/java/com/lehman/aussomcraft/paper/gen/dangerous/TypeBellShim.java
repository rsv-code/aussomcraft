...
public class TypeBellShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Bell self = (org.bukkit.block.data.type.Bell) this.getObj();
            if (self == null) {
    ...
    public AussomType getAttachment(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Bell) self).getAttachment());
            }
    ...
    public AussomType setAttachment(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Bell self = (org.bukkit.block.data.type.Bell) this.getObj();
            if (self == null) {
                return Marshal.detached("setAttachment");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Bell) self).setAttachment((org.bukkit.block.data.type.Bell.Attachment) Marshal.typed(args, 0, org.bukkit.block.data.type.Bell.Attachment.class));
                return new AussomNull();
            }
            return Marshal.wrongArity("setAttachment", n);
        } catch (Throwable e) {
            return Marshal.failed("setAttachment", e);
        }
    }
