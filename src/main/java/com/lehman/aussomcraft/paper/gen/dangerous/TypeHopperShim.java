...
public class TypeHopperShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Hopper self = (org.bukkit.block.data.type.Hopper) this.getObj();
            if (self == null) {
    ...
    public AussomType isEnabled(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Hopper) self).isEnabled());
            }
    ...
    public AussomType setEnabled(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.type.Hopper) self).setEnabled(Marshal.argBool(args, 0));
                return new AussomNull();
            }
