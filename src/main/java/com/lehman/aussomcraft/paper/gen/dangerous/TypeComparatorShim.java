...
public class TypeComparatorShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Comparator self = (org.bukkit.block.data.type.Comparator) this.getObj();
            if (self == null) {
    ...
    public AussomType getMode(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Comparator self = (org.bukkit.block.data.type.Comparator) this.getObj();
            if (self == null) {
                return Marshal.detached("getMode");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Comparator) self).getMode());
            }
            return Marshal.wrongArity("getMode", n);
        } catch (Throwable e) {
            return Marshal.failed("getMode", e);
        }
    }
    ...
    public AussomType setMode(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Comparator self = (org.bukkit.block.data.type.Comparator) this.getObj();
            if (self == null) {
                return Marshal.detached("setMode");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Comparator) self).setMode((org.bukkit.block.data.type.Comparator.Mode) Marshal.typed(args, 0, org.bukkit.block.data.type.Comparator.Mode.class));
                return new AussomNull();
            }
            return Marshal.wrongArity("setMode", n);
        } catch (Throwable e) {
            return Marshal.failed("setMode", e);
        }
    }
