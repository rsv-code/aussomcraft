...
public class TypeCrafterShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Crafter self = (org.bukkit.block.data.type.Crafter) this.getObj();
            if (self == null) {
    ...
    public AussomType getOrientation(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Crafter self = (org.bukkit.block.data.type.Crafter) this.getObj();
            if (self == null) {
                return Marshal.detached("getOrientation");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Crafter) self).getOrientation());
            }
            return Marshal.wrongArity("getOrientation", n);
        } catch (Throwable e) {
            return Marshal.failed("getOrientation", e);
        }
    }
    ...
    public AussomType isCrafting(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Crafter self = (org.bukkit.block.data.type.Crafter) this.getObj();
            if (self == null) {
                return Marshal.detached("isCrafting");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Crafter) self).isCrafting());
            }
            return Marshal.wrongArity("isCrafting", n);
        } catch (Throwable e) {
            return Marshal.failed("isCrafting", e);
        }
    }
    ...
    public AussomType isTriggered(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Crafter) self).isTriggered());
            }
    ...
    public AussomType setCrafting(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Crafter self = (org.bukkit.block.data.type.Crafter) this.getObj();
            if (self == null) {
                return Marshal.detached("setCrafting");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Crafter) self).setCrafting(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setCrafting", n);
        } catch (Throwable e) {
            return Marshal.failed("setCrafting", e);
        }
    }

    public AussomType setOrientation(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Crafter self = (org.bukkit.block.data.type.Crafter) this.getObj();
            if (self == null) {
                return Marshal.detached("setOrientation");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Crafter) self).setOrientation((org.bukkit.block.Orientation) Marshal.typed(args, 0, org.bukkit.block.Orientation.class));
                return new AussomNull();
            }
            return Marshal.wrongArity("setOrientation", n);
        } catch (Throwable e) {
            return Marshal.failed("setOrientation", e);
        }
    }
    ...
    public AussomType setTriggered(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.type.Crafter) self).setTriggered(Marshal.argBool(args, 0));
                return new AussomNull();
            }
