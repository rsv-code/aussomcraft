...
public class DriedGhastShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.DriedGhast self = (org.bukkit.block.data.type.DriedGhast) this.getObj();
            if (self == null) {
    ...
    public AussomType getHydration(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.DriedGhast self = (org.bukkit.block.data.type.DriedGhast) this.getObj();
            if (self == null) {
                return Marshal.detached("getHydration");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.DriedGhast) self).getHydration());
            }
            return Marshal.wrongArity("getHydration", n);
        } catch (Throwable e) {
            return Marshal.failed("getHydration", e);
        }
    }
    ...
    public AussomType getMaximumHydration(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.DriedGhast self = (org.bukkit.block.data.type.DriedGhast) this.getObj();
            if (self == null) {
                return Marshal.detached("getMaximumHydration");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.DriedGhast) self).getMaximumHydration());
            }
            return Marshal.wrongArity("getMaximumHydration", n);
        } catch (Throwable e) {
            return Marshal.failed("getMaximumHydration", e);
        }
    }
    ...
    public AussomType setHydration(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.DriedGhast self = (org.bukkit.block.data.type.DriedGhast) this.getObj();
            if (self == null) {
                return Marshal.detached("setHydration");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.DriedGhast) self).setHydration(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setHydration", n);
        } catch (Throwable e) {
            return Marshal.failed("setHydration", e);
        }
    }
