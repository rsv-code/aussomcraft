...
public class TNTShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.TNT self = (org.bukkit.block.data.type.TNT) this.getObj();
            if (self == null) {
    ...
    public AussomType isUnstable(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.TNT self = (org.bukkit.block.data.type.TNT) this.getObj();
            if (self == null) {
                return Marshal.detached("isUnstable");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.TNT) self).isUnstable());
            }
            return Marshal.wrongArity("isUnstable", n);
        } catch (Throwable e) {
            return Marshal.failed("isUnstable", e);
        }
    }
    ...
    public AussomType setUnstable(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.TNT self = (org.bukkit.block.data.type.TNT) this.getObj();
            if (self == null) {
                return Marshal.detached("setUnstable");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.TNT) self).setUnstable(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setUnstable", n);
        } catch (Throwable e) {
            return Marshal.failed("setUnstable", e);
        }
    }
