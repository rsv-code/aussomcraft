...
public class HopperShim extends PaperObj {
    ...
    public AussomType canPlayerLoot(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.Hopper self = (org.bukkit.block.Hopper) this.getObj();
            if (self == null) {
    ...
    public AussomType getTransferCooldown(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.Hopper self = (org.bukkit.block.Hopper) this.getObj();
            if (self == null) {
                return Marshal.detached("getTransferCooldown");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.Hopper) self).getTransferCooldown());
            }
            return Marshal.wrongArity("getTransferCooldown", n);
        } catch (Throwable e) {
            return Marshal.failed("getTransferCooldown", e);
        }
    }
    ...
    public AussomType setTransferCooldown(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.Hopper self = (org.bukkit.block.Hopper) this.getObj();
            if (self == null) {
                return Marshal.detached("setTransferCooldown");
            }
            if (n == 1) {
                ((org.bukkit.block.Hopper) self).setTransferCooldown(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setTransferCooldown", n);
        } catch (Throwable e) {
            return Marshal.failed("setTransferCooldown", e);
        }
    }
