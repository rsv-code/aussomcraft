...
public class FarmlandShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Farmland self = (org.bukkit.block.data.type.Farmland) this.getObj();
            if (self == null) {
    ...
    public AussomType getMaximumMoisture(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Farmland self = (org.bukkit.block.data.type.Farmland) this.getObj();
            if (self == null) {
                return Marshal.detached("getMaximumMoisture");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Farmland) self).getMaximumMoisture());
            }
            return Marshal.wrongArity("getMaximumMoisture", n);
        } catch (Throwable e) {
            return Marshal.failed("getMaximumMoisture", e);
        }
    }

    public AussomType getMoisture(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Farmland self = (org.bukkit.block.data.type.Farmland) this.getObj();
            if (self == null) {
                return Marshal.detached("getMoisture");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Farmland) self).getMoisture());
            }
            return Marshal.wrongArity("getMoisture", n);
        } catch (Throwable e) {
            return Marshal.failed("getMoisture", e);
        }
    }
    ...
    public AussomType setMoisture(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Farmland self = (org.bukkit.block.data.type.Farmland) this.getObj();
            if (self == null) {
                return Marshal.detached("setMoisture");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Farmland) self).setMoisture(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setMoisture", n);
        } catch (Throwable e) {
            return Marshal.failed("setMoisture", e);
        }
    }
