...
public class SnowShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Snow self = (org.bukkit.block.data.type.Snow) this.getObj();
            if (self == null) {
    ...
    public AussomType getLayers(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Snow self = (org.bukkit.block.data.type.Snow) this.getObj();
            if (self == null) {
                return Marshal.detached("getLayers");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Snow) self).getLayers());
            }
            return Marshal.wrongArity("getLayers", n);
        } catch (Throwable e) {
            return Marshal.failed("getLayers", e);
        }
    }
    ...
    public AussomType getMaximumLayers(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Snow self = (org.bukkit.block.data.type.Snow) this.getObj();
            if (self == null) {
                return Marshal.detached("getMaximumLayers");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Snow) self).getMaximumLayers());
            }
            return Marshal.wrongArity("getMaximumLayers", n);
        } catch (Throwable e) {
            return Marshal.failed("getMaximumLayers", e);
        }
    }

    public AussomType getMinimumLayers(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Snow self = (org.bukkit.block.data.type.Snow) this.getObj();
            if (self == null) {
                return Marshal.detached("getMinimumLayers");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Snow) self).getMinimumLayers());
            }
            return Marshal.wrongArity("getMinimumLayers", n);
        } catch (Throwable e) {
            return Marshal.failed("getMinimumLayers", e);
        }
    }
    ...
    public AussomType setLayers(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Snow self = (org.bukkit.block.data.type.Snow) this.getObj();
            if (self == null) {
                return Marshal.detached("setLayers");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Snow) self).setLayers(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setLayers", n);
        } catch (Throwable e) {
            return Marshal.failed("setLayers", e);
        }
    }
