...
public class TypeChestShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Chest self = (org.bukkit.block.data.type.Chest) this.getObj();
            if (self == null) {
    ...
    public AussomType getType(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Chest) self).getType());
            }
    ...
    public AussomType setType(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.type.Chest) self).setType((org.bukkit.block.data.type.Chest.Type) Marshal.typed(args, 0, org.bukkit.block.data.type.Chest.Type.class));
                return new AussomNull();
            }
