...
public class ArmorMetaShim extends PaperObj {
    ...
    public AussomType addAttributeModifier(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.inventory.meta.ArmorMeta self = (org.bukkit.inventory.meta.ArmorMeta) this.getObj();
            if (self == null) {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.inventory.meta.ArmorMeta) self).clone());
            }
