...
public class TechnicalPistonShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.TechnicalPiston self = (org.bukkit.block.data.type.TechnicalPiston) this.getObj();
            if (self == null) {
