...
public class StairsShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Stairs self = (org.bukkit.block.data.type.Stairs) this.getObj();
            if (self == null) {
    ...
    public AussomType getShape(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Stairs self = (org.bukkit.block.data.type.Stairs) this.getObj();
            if (self == null) {
                return Marshal.detached("getShape");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Stairs) self).getShape());
            }
            return Marshal.wrongArity("getShape", n);
        } catch (Throwable e) {
            return Marshal.failed("getShape", e);
        }
    }
    ...
    public AussomType setShape(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Stairs self = (org.bukkit.block.data.type.Stairs) this.getObj();
            if (self == null) {
                return Marshal.detached("setShape");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Stairs) self).setShape((org.bukkit.block.data.type.Stairs.Shape) Marshal.typed(args, 0, org.bukkit.block.data.type.Stairs.Shape.class));
                return new AussomNull();
            }
            return Marshal.wrongArity("setShape", n);
        } catch (Throwable e) {
            return Marshal.failed("setShape", e);
        }
    }
