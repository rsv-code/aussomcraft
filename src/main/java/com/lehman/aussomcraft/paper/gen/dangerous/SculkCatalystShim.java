...
public class SculkCatalystShim extends PaperObj {

    public AussomType bloom(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.SculkCatalyst self = (org.bukkit.block.SculkCatalyst) this.getObj();
            if (self == null) {
                return Marshal.detached("bloom");
            }
            if (n == 2) {
                ((org.bukkit.block.SculkCatalyst) self).bloom((org.bukkit.block.Block) Marshal.typed(args, 0, org.bukkit.block.Block.class), Marshal.argInt(args, 1));
                return new AussomNull();
            }
            return Marshal.wrongArity("bloom", n);
        } catch (Throwable e) {
            return Marshal.failed("bloom", e);
        }
    }

    public AussomType bloom_position_charge(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.SculkCatalyst self = (org.bukkit.block.SculkCatalyst) this.getObj();
            if (self == null) {
                return Marshal.detached("bloom_position_charge");
            }
            if (n == 2) {
                ((org.bukkit.block.SculkCatalyst) self).bloom((io.papermc.paper.math.Position) Marshal.typed(args, 0, io.papermc.paper.math.Position.class), Marshal.argInt(args, 1));
                return new AussomNull();
            }
            return Marshal.wrongArity("bloom_position_charge", n);
        } catch (Throwable e) {
            return Marshal.failed("bloom_position_charge", e);
        }
    }
