...
public class EndPortalFrameShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.EndPortalFrame self = (org.bukkit.block.data.type.EndPortalFrame) this.getObj();
            if (self == null) {
    ...
    public AussomType hasEye(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.EndPortalFrame self = (org.bukkit.block.data.type.EndPortalFrame) this.getObj();
            if (self == null) {
                return Marshal.detached("hasEye");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.EndPortalFrame) self).hasEye());
            }
            return Marshal.wrongArity("hasEye", n);
        } catch (Throwable e) {
            return Marshal.failed("hasEye", e);
        }
    }
    ...
    public AussomType setEye(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.EndPortalFrame self = (org.bukkit.block.data.type.EndPortalFrame) this.getObj();
            if (self == null) {
                return Marshal.detached("setEye");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.EndPortalFrame) self).setEye(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setEye", n);
        } catch (Throwable e) {
            return Marshal.failed("setEye", e);
        }
    }
