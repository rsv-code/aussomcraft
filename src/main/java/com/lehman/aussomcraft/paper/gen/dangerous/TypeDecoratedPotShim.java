...
public class TypeDecoratedPotShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.DecoratedPot self = (org.bukkit.block.data.type.DecoratedPot) this.getObj();
            if (self == null) {
    ...
    public AussomType isCracked(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.DecoratedPot self = (org.bukkit.block.data.type.DecoratedPot) this.getObj();
            if (self == null) {
                return Marshal.detached("isCracked");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.DecoratedPot) self).isCracked());
            }
            return Marshal.wrongArity("isCracked", n);
        } catch (Throwable e) {
            return Marshal.failed("isCracked", e);
        }
    }
    ...
    public AussomType setCracked(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.DecoratedPot self = (org.bukkit.block.data.type.DecoratedPot) this.getObj();
            if (self == null) {
                return Marshal.detached("setCracked");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.DecoratedPot) self).setCracked(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setCracked", n);
        } catch (Throwable e) {
            return Marshal.failed("setCracked", e);
        }
    }
