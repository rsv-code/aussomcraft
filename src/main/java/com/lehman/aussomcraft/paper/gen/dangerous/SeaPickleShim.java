...
public class SeaPickleShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.SeaPickle self = (org.bukkit.block.data.type.SeaPickle) this.getObj();
            if (self == null) {
    ...
    public AussomType getMaximumPickles(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.SeaPickle self = (org.bukkit.block.data.type.SeaPickle) this.getObj();
            if (self == null) {
                return Marshal.detached("getMaximumPickles");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.SeaPickle) self).getMaximumPickles());
            }
            return Marshal.wrongArity("getMaximumPickles", n);
        } catch (Throwable e) {
            return Marshal.failed("getMaximumPickles", e);
        }
    }

    public AussomType getMinimumPickles(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.SeaPickle self = (org.bukkit.block.data.type.SeaPickle) this.getObj();
            if (self == null) {
                return Marshal.detached("getMinimumPickles");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.SeaPickle) self).getMinimumPickles());
            }
            return Marshal.wrongArity("getMinimumPickles", n);
        } catch (Throwable e) {
            return Marshal.failed("getMinimumPickles", e);
        }
    }

    public AussomType getPickles(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.SeaPickle self = (org.bukkit.block.data.type.SeaPickle) this.getObj();
            if (self == null) {
                return Marshal.detached("getPickles");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.SeaPickle) self).getPickles());
            }
            return Marshal.wrongArity("getPickles", n);
        } catch (Throwable e) {
            return Marshal.failed("getPickles", e);
        }
    }
    ...
    public AussomType setPickles(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.SeaPickle self = (org.bukkit.block.data.type.SeaPickle) this.getObj();
            if (self == null) {
                return Marshal.detached("setPickles");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.SeaPickle) self).setPickles(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setPickles", n);
        } catch (Throwable e) {
            return Marshal.failed("setPickles", e);
        }
    }
