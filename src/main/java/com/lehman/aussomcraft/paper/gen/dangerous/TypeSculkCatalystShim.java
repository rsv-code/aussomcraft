...
public class TypeSculkCatalystShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.SculkCatalyst self = (org.bukkit.block.data.type.SculkCatalyst) this.getObj();
            if (self == null) {
    ...
    public AussomType isBloom(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.SculkCatalyst self = (org.bukkit.block.data.type.SculkCatalyst) this.getObj();
            if (self == null) {
                return Marshal.detached("isBloom");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.SculkCatalyst) self).isBloom());
            }
            return Marshal.wrongArity("isBloom", n);
        } catch (Throwable e) {
            return Marshal.failed("isBloom", e);
        }
    }
    ...
    public AussomType setBloom(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.SculkCatalyst self = (org.bukkit.block.data.type.SculkCatalyst) this.getObj();
            if (self == null) {
                return Marshal.detached("setBloom");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.SculkCatalyst) self).setBloom(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setBloom", n);
        } catch (Throwable e) {
            return Marshal.failed("setBloom", e);
        }
    }
