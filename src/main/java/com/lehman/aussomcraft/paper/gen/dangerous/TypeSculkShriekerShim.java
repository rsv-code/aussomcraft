...
public class TypeSculkShriekerShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.SculkShrieker self = (org.bukkit.block.data.type.SculkShrieker) this.getObj();
            if (self == null) {
    ...
    public AussomType isCanSummon(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.SculkShrieker self = (org.bukkit.block.data.type.SculkShrieker) this.getObj();
            if (self == null) {
                return Marshal.detached("isCanSummon");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.SculkShrieker) self).isCanSummon());
            }
            return Marshal.wrongArity("isCanSummon", n);
        } catch (Throwable e) {
            return Marshal.failed("isCanSummon", e);
        }
    }
    ...
    public AussomType isShrieking(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.SculkShrieker self = (org.bukkit.block.data.type.SculkShrieker) this.getObj();
            if (self == null) {
                return Marshal.detached("isShrieking");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.SculkShrieker) self).isShrieking());
            }
            return Marshal.wrongArity("isShrieking", n);
        } catch (Throwable e) {
            return Marshal.failed("isShrieking", e);
        }
    }
    ...
    public AussomType setCanSummon(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.SculkShrieker self = (org.bukkit.block.data.type.SculkShrieker) this.getObj();
            if (self == null) {
                return Marshal.detached("setCanSummon");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.SculkShrieker) self).setCanSummon(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setCanSummon", n);
        } catch (Throwable e) {
            return Marshal.failed("setCanSummon", e);
        }
    }

    public AussomType setShrieking(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.SculkShrieker self = (org.bukkit.block.data.type.SculkShrieker) this.getObj();
            if (self == null) {
                return Marshal.detached("setShrieking");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.SculkShrieker) self).setShrieking(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setShrieking", n);
        } catch (Throwable e) {
            return Marshal.failed("setShrieking", e);
        }
    }
