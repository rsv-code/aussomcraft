...
public class BlockDisplayShim extends PaperObj {
    ...
    public AussomType addPassenger(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.entity.BlockDisplay self = (org.bukkit.entity.BlockDisplay) this.getObj();
            if (self == null) {
    ...
    public AussomType getBlock(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.entity.BlockDisplay) self).getBlock());
            }
    ...
    public AussomType setBlock(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.entity.BlockDisplay self = (org.bukkit.entity.BlockDisplay) this.getObj();
            if (self == null) {
                return Marshal.detached("setBlock");
            }
            if (n == 1) {
                ((org.bukkit.entity.BlockDisplay) self).setBlock((org.bukkit.block.data.BlockData) Marshal.typed(args, 0, org.bukkit.block.data.BlockData.class));
                return new AussomNull();
            }
            return Marshal.wrongArity("setBlock", n);
        } catch (Throwable e) {
            return Marshal.failed("setBlock", e);
        }
    }
