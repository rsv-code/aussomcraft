...
public class RemoteConsoleCommandSenderShim extends PaperObj {
    ...
    public AussomType clearResourcePacks(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.command.RemoteConsoleCommandSender self = (org.bukkit.command.RemoteConsoleCommandSender) this.getObj();
            if (self == null) {
