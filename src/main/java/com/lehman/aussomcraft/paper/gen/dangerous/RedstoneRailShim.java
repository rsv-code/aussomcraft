...
public class RedstoneRailShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.RedstoneRail self = (org.bukkit.block.data.type.RedstoneRail) this.getObj();
            if (self == null) {
    ...
    public AussomType getShape(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.Rail) self).getShape());
            }
    ...
    public AussomType getShapes(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.RedstoneRail self = (org.bukkit.block.data.type.RedstoneRail) this.getObj();
            if (self == null) {
                return Marshal.detached("getShapes");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.Rail) self).getShapes());
            }
            return Marshal.wrongArity("getShapes", n);
        } catch (Throwable e) {
            return Marshal.failed("getShapes", e);
        }
    }
    ...
    public AussomType setShape(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.Rail) self).setShape((org.bukkit.block.data.Rail.Shape) Marshal.typed(args, 0, org.bukkit.block.data.Rail.Shape.class));
                return new AussomNull();
            }
