...
public class KnowledgeBookMetaShim extends PaperObj {
    ...
    public AussomType addAttributeModifier(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.inventory.meta.KnowledgeBookMeta self = (org.bukkit.inventory.meta.KnowledgeBookMeta) this.getObj();
            if (self == null) {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.inventory.meta.KnowledgeBookMeta) self).clone());
            }
    ...
    public AussomType getRecipes(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.inventory.meta.KnowledgeBookMeta) self).getRecipes());
            }
    ...
    public AussomType hasRecipes(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.inventory.meta.KnowledgeBookMeta self = (org.bukkit.inventory.meta.KnowledgeBookMeta) this.getObj();
            if (self == null) {
                return Marshal.detached("hasRecipes");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.inventory.meta.KnowledgeBookMeta) self).hasRecipes());
            }
            return Marshal.wrongArity("hasRecipes", n);
        } catch (Throwable e) {
            return Marshal.failed("hasRecipes", e);
        }
    }
    ...
    public AussomType setRecipes(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.inventory.meta.KnowledgeBookMeta) self).setRecipes((java.util.List) Marshal.typed(args, 0, java.util.List.class));
                return new AussomNull();
            }
