...
public class WallShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Wall self = (org.bukkit.block.data.type.Wall) this.getObj();
            if (self == null) {
    ...
    public AussomType getHeight(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Wall) self).getHeight((org.bukkit.block.BlockFace) Marshal.typed(args, 0, org.bukkit.block.BlockFace.class)));
            }
    ...
    public AussomType isUp(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Wall self = (org.bukkit.block.data.type.Wall) this.getObj();
            if (self == null) {
                return Marshal.detached("isUp");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Wall) self).isUp());
            }
            return Marshal.wrongArity("isUp", n);
        } catch (Throwable e) {
            return Marshal.failed("isUp", e);
        }
    }
    ...
    public AussomType setHeight(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Wall self = (org.bukkit.block.data.type.Wall) this.getObj();
            if (self == null) {
                return Marshal.detached("setHeight");
            }
            if (n == 2) {
                ((org.bukkit.block.data.type.Wall) self).setHeight((org.bukkit.block.BlockFace) Marshal.typed(args, 0, org.bukkit.block.BlockFace.class), (org.bukkit.block.data.type.Wall.Height) Marshal.typed(args, 1, org.bukkit.block.data.type.Wall.Height.class));
                return new AussomNull();
            }
            return Marshal.wrongArity("setHeight", n);
        } catch (Throwable e) {
            return Marshal.failed("setHeight", e);
        }
    }

    public AussomType setUp(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Wall self = (org.bukkit.block.data.type.Wall) this.getObj();
            if (self == null) {
                return Marshal.detached("setUp");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Wall) self).setUp(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setUp", n);
        } catch (Throwable e) {
            return Marshal.failed("setUp", e);
        }
    }
