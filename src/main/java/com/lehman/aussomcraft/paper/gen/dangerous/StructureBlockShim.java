...
public class StructureBlockShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.StructureBlock self = (org.bukkit.block.data.type.StructureBlock) this.getObj();
            if (self == null) {
    ...
    public AussomType getMode(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.StructureBlock) self).getMode());
            }
    ...
    public AussomType setMode(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.type.StructureBlock) self).setMode((org.bukkit.block.data.type.StructureBlock.Mode) Marshal.typed(args, 0, org.bukkit.block.data.type.StructureBlock.Mode.class));
                return new AussomNull();
            }
