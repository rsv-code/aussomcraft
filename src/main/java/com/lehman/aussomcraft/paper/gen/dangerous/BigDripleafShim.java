...
public class BigDripleafShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.BigDripleaf self = (org.bukkit.block.data.type.BigDripleaf) this.getObj();
            if (self == null) {
    ...
    public AussomType getTilt(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.BigDripleaf self = (org.bukkit.block.data.type.BigDripleaf) this.getObj();
            if (self == null) {
                return Marshal.detached("getTilt");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.BigDripleaf) self).getTilt());
            }
            return Marshal.wrongArity("getTilt", n);
        } catch (Throwable e) {
            return Marshal.failed("getTilt", e);
        }
    }
    ...
    public AussomType setTilt(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.BigDripleaf self = (org.bukkit.block.data.type.BigDripleaf) this.getObj();
            if (self == null) {
                return Marshal.detached("setTilt");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.BigDripleaf) self).setTilt((org.bukkit.block.data.type.BigDripleaf.Tilt) Marshal.typed(args, 0, org.bukkit.block.data.type.BigDripleaf.Tilt.class));
                return new AussomNull();
            }
            return Marshal.wrongArity("setTilt", n);
        } catch (Throwable e) {
            return Marshal.failed("setTilt", e);
        }
    }
