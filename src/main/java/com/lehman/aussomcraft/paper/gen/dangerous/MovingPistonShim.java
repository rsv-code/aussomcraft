...
public class MovingPistonShim extends PaperObj {
    ...
    public AussomType copy(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            io.papermc.paper.block.MovingPiston self = (io.papermc.paper.block.MovingPiston) this.getObj();
            if (self == null) {
    ...
    public AussomType getDirection(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((io.papermc.paper.block.MovingPiston) self).getDirection());
            }
    ...
    public AussomType getMovingBlock(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            io.papermc.paper.block.MovingPiston self = (io.papermc.paper.block.MovingPiston) this.getObj();
            if (self == null) {
                return Marshal.detached("getMovingBlock");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((io.papermc.paper.block.MovingPiston) self).getMovingBlock());
            }
            return Marshal.wrongArity("getMovingBlock", n);
        } catch (Throwable e) {
            return Marshal.failed("getMovingBlock", e);
        }
    }
    ...
    public AussomType isExtending(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            io.papermc.paper.block.MovingPiston self = (io.papermc.paper.block.MovingPiston) this.getObj();
            if (self == null) {
                return Marshal.detached("isExtending");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((io.papermc.paper.block.MovingPiston) self).isExtending());
            }
            return Marshal.wrongArity("isExtending", n);
        } catch (Throwable e) {
            return Marshal.failed("isExtending", e);
        }
    }

    public AussomType isPistonHead(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            io.papermc.paper.block.MovingPiston self = (io.papermc.paper.block.MovingPiston) this.getObj();
            if (self == null) {
                return Marshal.detached("isPistonHead");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((io.papermc.paper.block.MovingPiston) self).isPistonHead());
            }
            return Marshal.wrongArity("isPistonHead", n);
        } catch (Throwable e) {
            return Marshal.failed("isPistonHead", e);
        }
    }
