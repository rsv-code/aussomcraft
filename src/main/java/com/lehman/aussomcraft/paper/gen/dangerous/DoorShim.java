...
public class DoorShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Door self = (org.bukkit.block.data.type.Door) this.getObj();
            if (self == null) {
    ...
    public AussomType getHalf(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Door self = (org.bukkit.block.data.type.Door) this.getObj();
            if (self == null) {
                return Marshal.detached("getHalf");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.Bisected) self).getHalf());
            }
            return Marshal.wrongArity("getHalf", n);
        } catch (Throwable e) {
            return Marshal.failed("getHalf", e);
        }
    }
    ...
    public AussomType getHinge(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Door) self).getHinge());
            }
    ...
    public AussomType isOpen(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.Openable) self).isOpen());
            }
    ...
    public AussomType setHalf(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Door self = (org.bukkit.block.data.type.Door) this.getObj();
            if (self == null) {
                return Marshal.detached("setHalf");
            }
            if (n == 1) {
                ((org.bukkit.block.data.Bisected) self).setHalf((org.bukkit.block.data.Bisected.Half) Marshal.typed(args, 0, org.bukkit.block.data.Bisected.Half.class));
                return new AussomNull();
            }
            return Marshal.wrongArity("setHalf", n);
        } catch (Throwable e) {
            return Marshal.failed("setHalf", e);
        }
    }
    ...
    public AussomType setHinge(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.type.Door) self).setHinge((org.bukkit.block.data.type.Door.Hinge) Marshal.typed(args, 0, org.bukkit.block.data.type.Door.Hinge.class));
                return new AussomNull();
            }
    ...
    public AussomType setOpen(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.Openable) self).setOpen(Marshal.argBool(args, 0));
                return new AussomNull();
            }
