...
public class PistonHeadShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.PistonHead self = (org.bukkit.block.data.type.PistonHead) this.getObj();
            if (self == null) {
    ...
    public AussomType getType(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.TechnicalPiston) self).getType());
            }
    ...
    public AussomType isShort(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.PistonHead self = (org.bukkit.block.data.type.PistonHead) this.getObj();
            if (self == null) {
                return Marshal.detached("isShort");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.PistonHead) self).isShort());
            }
            return Marshal.wrongArity("isShort", n);
        } catch (Throwable e) {
            return Marshal.failed("isShort", e);
        }
    }
    ...
    public AussomType setShort(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.PistonHead self = (org.bukkit.block.data.type.PistonHead) this.getObj();
            if (self == null) {
                return Marshal.detached("setShort");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.PistonHead) self).setShort(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setShort", n);
        } catch (Throwable e) {
            return Marshal.failed("setShort", e);
        }
    }
    ...
    public AussomType setType(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.type.TechnicalPiston) self).setType((org.bukkit.block.data.type.TechnicalPiston.Type) Marshal.typed(args, 0, org.bukkit.block.data.type.TechnicalPiston.Type.class));
                return new AussomNull();
            }
