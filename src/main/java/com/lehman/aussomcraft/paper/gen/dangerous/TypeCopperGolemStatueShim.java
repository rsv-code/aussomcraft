...
public class TypeCopperGolemStatueShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.CopperGolemStatue self = (org.bukkit.block.data.type.CopperGolemStatue) this.getObj();
            if (self == null) {
    ...
    public AussomType getCopperGolemPose(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.CopperGolemStatue self = (org.bukkit.block.data.type.CopperGolemStatue) this.getObj();
            if (self == null) {
                return Marshal.detached("getCopperGolemPose");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.CopperGolemStatue) self).getCopperGolemPose());
            }
            return Marshal.wrongArity("getCopperGolemPose", n);
        } catch (Throwable e) {
            return Marshal.failed("getCopperGolemPose", e);
        }
    }
    ...
    public AussomType setCopperGolemPose(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.CopperGolemStatue self = (org.bukkit.block.data.type.CopperGolemStatue) this.getObj();
            if (self == null) {
                return Marshal.detached("setCopperGolemPose");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.CopperGolemStatue) self).setCopperGolemPose((org.bukkit.block.data.type.CopperGolemStatue.Pose) Marshal.typed(args, 0, org.bukkit.block.data.type.CopperGolemStatue.Pose.class));
                return new AussomNull();
            }
            return Marshal.wrongArity("setCopperGolemPose", n);
        } catch (Throwable e) {
            return Marshal.failed("setCopperGolemPose", e);
        }
    }
