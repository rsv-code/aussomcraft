...
public class ScaffoldingShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Scaffolding self = (org.bukkit.block.data.type.Scaffolding) this.getObj();
            if (self == null) {
    ...
    public AussomType getDistance(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Scaffolding self = (org.bukkit.block.data.type.Scaffolding) this.getObj();
            if (self == null) {
                return Marshal.detached("getDistance");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Scaffolding) self).getDistance());
            }
            return Marshal.wrongArity("getDistance", n);
        } catch (Throwable e) {
            return Marshal.failed("getDistance", e);
        }
    }
    ...
    public AussomType getMaximumDistance(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Scaffolding self = (org.bukkit.block.data.type.Scaffolding) this.getObj();
            if (self == null) {
                return Marshal.detached("getMaximumDistance");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Scaffolding) self).getMaximumDistance());
            }
            return Marshal.wrongArity("getMaximumDistance", n);
        } catch (Throwable e) {
            return Marshal.failed("getMaximumDistance", e);
        }
    }
    ...
    public AussomType isBottom(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Scaffolding self = (org.bukkit.block.data.type.Scaffolding) this.getObj();
            if (self == null) {
                return Marshal.detached("isBottom");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Scaffolding) self).isBottom());
            }
            return Marshal.wrongArity("isBottom", n);
        } catch (Throwable e) {
            return Marshal.failed("isBottom", e);
        }
    }
    ...
    public AussomType setBottom(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Scaffolding self = (org.bukkit.block.data.type.Scaffolding) this.getObj();
            if (self == null) {
                return Marshal.detached("setBottom");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Scaffolding) self).setBottom(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setBottom", n);
        } catch (Throwable e) {
            return Marshal.failed("setBottom", e);
        }
    }

    public AussomType setDistance(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Scaffolding self = (org.bukkit.block.data.type.Scaffolding) this.getObj();
            if (self == null) {
                return Marshal.detached("setDistance");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Scaffolding) self).setDistance(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setDistance", n);
        } catch (Throwable e) {
            return Marshal.failed("setDistance", e);
        }
    }
