...
public class PaintingShim extends PaperObj {
    ...
    public AussomType addPassenger(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.entity.Painting self = (org.bukkit.entity.Painting) this.getObj();
            if (self == null) {
    ...
    public AussomType getArt(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.entity.Painting self = (org.bukkit.entity.Painting) this.getObj();
            if (self == null) {
                return Marshal.detached("getArt");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.entity.Painting) self).getArt());
            }
            return Marshal.wrongArity("getArt", n);
        } catch (Throwable e) {
            return Marshal.failed("getArt", e);
        }
    }
    ...
    public AussomType setArt(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.entity.Painting self = (org.bukkit.entity.Painting) this.getObj();
            if (self == null) {
                return Marshal.detached("setArt");
            }
            if (n == 1) {
                return Marshal.wrap(env, ((org.bukkit.entity.Painting) self).setArt((org.bukkit.Art) Marshal.typed(args, 0, org.bukkit.Art.class)));
            }
            if (n == 2) {
                return Marshal.wrap(env, ((org.bukkit.entity.Painting) self).setArt((org.bukkit.Art) Marshal.typed(args, 0, org.bukkit.Art.class), Marshal.argBool(args, 1)));
            }
            return Marshal.wrongArity("setArt", n);
        } catch (Throwable e) {
            return Marshal.failed("setArt", e);
        }
    }
