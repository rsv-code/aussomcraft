...
public class TypeChiseledBookshelfShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.ChiseledBookshelf self = (org.bukkit.block.data.type.ChiseledBookshelf) this.getObj();
            if (self == null) {
    ...
    public AussomType getMaximumOccupiedSlots(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.ChiseledBookshelf self = (org.bukkit.block.data.type.ChiseledBookshelf) this.getObj();
            if (self == null) {
                return Marshal.detached("getMaximumOccupiedSlots");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.ChiseledBookshelf) self).getMaximumOccupiedSlots());
            }
            return Marshal.wrongArity("getMaximumOccupiedSlots", n);
        } catch (Throwable e) {
            return Marshal.failed("getMaximumOccupiedSlots", e);
        }
    }

    public AussomType getOccupiedSlots(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.ChiseledBookshelf self = (org.bukkit.block.data.type.ChiseledBookshelf) this.getObj();
            if (self == null) {
                return Marshal.detached("getOccupiedSlots");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.ChiseledBookshelf) self).getOccupiedSlots());
            }
            return Marshal.wrongArity("getOccupiedSlots", n);
        } catch (Throwable e) {
            return Marshal.failed("getOccupiedSlots", e);
        }
    }
    ...
    public AussomType isSlotOccupied(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.ChiseledBookshelf self = (org.bukkit.block.data.type.ChiseledBookshelf) this.getObj();
            if (self == null) {
                return Marshal.detached("isSlotOccupied");
            }
            if (n == 1) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.ChiseledBookshelf) self).isSlotOccupied(Marshal.argInt(args, 0)));
            }
            return Marshal.wrongArity("isSlotOccupied", n);
        } catch (Throwable e) {
            return Marshal.failed("isSlotOccupied", e);
        }
    }
    ...
    public AussomType setSlotOccupied(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.ChiseledBookshelf self = (org.bukkit.block.data.type.ChiseledBookshelf) this.getObj();
            if (self == null) {
                return Marshal.detached("setSlotOccupied");
            }
            if (n == 2) {
                ((org.bukkit.block.data.type.ChiseledBookshelf) self).setSlotOccupied(Marshal.argInt(args, 0), Marshal.argBool(args, 1));
                return new AussomNull();
            }
            return Marshal.wrongArity("setSlotOccupied", n);
        } catch (Throwable e) {
            return Marshal.failed("setSlotOccupied", e);
        }
    }
