...
public class TypeBeehiveShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Beehive self = (org.bukkit.block.data.type.Beehive) this.getObj();
            if (self == null) {
    ...
    public AussomType getHoneyLevel(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Beehive self = (org.bukkit.block.data.type.Beehive) this.getObj();
            if (self == null) {
                return Marshal.detached("getHoneyLevel");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Beehive) self).getHoneyLevel());
            }
            return Marshal.wrongArity("getHoneyLevel", n);
        } catch (Throwable e) {
            return Marshal.failed("getHoneyLevel", e);
        }
    }
    ...
    public AussomType getMaximumHoneyLevel(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Beehive self = (org.bukkit.block.data.type.Beehive) this.getObj();
            if (self == null) {
                return Marshal.detached("getMaximumHoneyLevel");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Beehive) self).getMaximumHoneyLevel());
            }
            return Marshal.wrongArity("getMaximumHoneyLevel", n);
        } catch (Throwable e) {
            return Marshal.failed("getMaximumHoneyLevel", e);
        }
    }
    ...
    public AussomType setHoneyLevel(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Beehive self = (org.bukkit.block.data.type.Beehive) this.getObj();
            if (self == null) {
                return Marshal.detached("setHoneyLevel");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Beehive) self).setHoneyLevel(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setHoneyLevel", n);
        } catch (Throwable e) {
            return Marshal.failed("setHoneyLevel", e);
        }
    }
