...
public class TypeCommandBlockShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.CommandBlock self = (org.bukkit.block.data.type.CommandBlock) this.getObj();
            if (self == null) {
    ...
    public AussomType isConditional(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.CommandBlock self = (org.bukkit.block.data.type.CommandBlock) this.getObj();
            if (self == null) {
                return Marshal.detached("isConditional");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.CommandBlock) self).isConditional());
            }
            return Marshal.wrongArity("isConditional", n);
        } catch (Throwable e) {
            return Marshal.failed("isConditional", e);
        }
    }
    ...
    public AussomType setConditional(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.CommandBlock self = (org.bukkit.block.data.type.CommandBlock) this.getObj();
            if (self == null) {
                return Marshal.detached("setConditional");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.CommandBlock) self).setConditional(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setConditional", n);
        } catch (Throwable e) {
            return Marshal.failed("setConditional", e);
        }
    }
