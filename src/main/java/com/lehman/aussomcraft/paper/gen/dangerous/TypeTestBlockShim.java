...
public class TypeTestBlockShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.TestBlock self = (org.bukkit.block.data.type.TestBlock) this.getObj();
            if (self == null) {
    ...
    public AussomType getMode(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.TestBlock) self).getMode());
            }
    ...
    public AussomType setMode(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.type.TestBlock) self).setMode((org.bukkit.block.data.type.TestBlock.Mode) Marshal.typed(args, 0, org.bukkit.block.data.type.TestBlock.Mode.class));
                return new AussomNull();
            }
