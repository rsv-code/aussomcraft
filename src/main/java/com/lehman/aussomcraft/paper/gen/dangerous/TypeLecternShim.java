...
public class TypeLecternShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Lectern self = (org.bukkit.block.data.type.Lectern) this.getObj();
            if (self == null) {
    ...
    public AussomType hasBook(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Lectern self = (org.bukkit.block.data.type.Lectern) this.getObj();
            if (self == null) {
                return Marshal.detached("hasBook");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Lectern) self).hasBook());
            }
            return Marshal.wrongArity("hasBook", n);
        } catch (Throwable e) {
            return Marshal.failed("hasBook", e);
        }
    }
    ...
    public AussomType setHasBook(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Lectern self = (org.bukkit.block.data.type.Lectern) this.getObj();
            if (self == null) {
                return Marshal.detached("setHasBook");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Lectern) self).setHasBook(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setHasBook", n);
        } catch (Throwable e) {
            return Marshal.failed("setHasBook", e);
        }
    }
