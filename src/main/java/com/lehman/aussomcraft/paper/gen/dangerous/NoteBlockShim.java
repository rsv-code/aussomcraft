...
public class NoteBlockShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.NoteBlock self = (org.bukkit.block.data.type.NoteBlock) this.getObj();
            if (self == null) {
    ...
    public AussomType getInstrument(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.NoteBlock) self).getInstrument());
            }
    ...
    public AussomType getNote(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.NoteBlock) self).getNote());
            }
    ...
    public AussomType setInstrument(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.type.NoteBlock) self).setInstrument((org.bukkit.Instrument) Marshal.typed(args, 0, org.bukkit.Instrument.class));
                return new AussomNull();
            }
    ...
    public AussomType setNote(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.type.NoteBlock) self).setNote((org.bukkit.Note) Marshal.typed(args, 0, org.bukkit.Note.class));
                return new AussomNull();
            }
