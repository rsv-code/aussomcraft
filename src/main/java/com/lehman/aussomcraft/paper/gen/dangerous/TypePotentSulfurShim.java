...
public class TypePotentSulfurShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.PotentSulfur self = (org.bukkit.block.data.type.PotentSulfur) this.getObj();
            if (self == null) {
    ...
    public AussomType getPotentSulfurState(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.PotentSulfur self = (org.bukkit.block.data.type.PotentSulfur) this.getObj();
            if (self == null) {
                return Marshal.detached("getPotentSulfurState");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.PotentSulfur) self).getPotentSulfurState());
            }
            return Marshal.wrongArity("getPotentSulfurState", n);
        } catch (Throwable e) {
            return Marshal.failed("getPotentSulfurState", e);
        }
    }
    ...
    public AussomType setPotentSulfurState(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.PotentSulfur self = (org.bukkit.block.data.type.PotentSulfur) this.getObj();
            if (self == null) {
                return Marshal.detached("setPotentSulfurState");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.PotentSulfur) self).setPotentSulfurState((org.bukkit.block.data.type.PotentSulfur.State) Marshal.typed(args, 0, org.bukkit.block.data.type.PotentSulfur.State.class));
                return new AussomNull();
            }
            return Marshal.wrongArity("setPotentSulfurState", n);
        } catch (Throwable e) {
            return Marshal.failed("setPotentSulfurState", e);
        }
    }
