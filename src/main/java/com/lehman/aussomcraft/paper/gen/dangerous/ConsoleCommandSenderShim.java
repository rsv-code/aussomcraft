...
public class ConsoleCommandSenderShim extends PaperObj {
    ...
    public AussomType abandonConversation(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.command.ConsoleCommandSender self = (org.bukkit.command.ConsoleCommandSender) this.getObj();
            if (self == null) {
