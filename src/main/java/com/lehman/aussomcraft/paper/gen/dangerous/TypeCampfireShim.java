...
public class TypeCampfireShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Campfire self = (org.bukkit.block.data.type.Campfire) this.getObj();
            if (self == null) {
    ...
    public AussomType isLit(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Campfire self = (org.bukkit.block.data.type.Campfire) this.getObj();
            if (self == null) {
                return Marshal.detached("isLit");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.Lightable) self).isLit());
            }
            return Marshal.wrongArity("isLit", n);
        } catch (Throwable e) {
            return Marshal.failed("isLit", e);
        }
    }
    ...
    public AussomType isSignalFire(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Campfire self = (org.bukkit.block.data.type.Campfire) this.getObj();
            if (self == null) {
                return Marshal.detached("isSignalFire");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Campfire) self).isSignalFire());
            }
            return Marshal.wrongArity("isSignalFire", n);
        } catch (Throwable e) {
            return Marshal.failed("isSignalFire", e);
        }
    }
    ...
    public AussomType setLit(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Campfire self = (org.bukkit.block.data.type.Campfire) this.getObj();
            if (self == null) {
                return Marshal.detached("setLit");
            }
            if (n == 1) {
                ((org.bukkit.block.data.Lightable) self).setLit(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setLit", n);
        } catch (Throwable e) {
            return Marshal.failed("setLit", e);
        }
    }

    public AussomType setSignalFire(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Campfire self = (org.bukkit.block.data.type.Campfire) this.getObj();
            if (self == null) {
                return Marshal.detached("setSignalFire");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Campfire) self).setSignalFire(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setSignalFire", n);
        } catch (Throwable e) {
            return Marshal.failed("setSignalFire", e);
        }
    }
