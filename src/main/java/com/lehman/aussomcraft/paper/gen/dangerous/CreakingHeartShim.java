...
public class CreakingHeartShim extends PaperObj {
    ...
    public AussomType copy(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.CreakingHeart self = (org.bukkit.block.CreakingHeart) this.getObj();
            if (self == null) {
    ...
    public AussomType getCreaking(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.CreakingHeart self = (org.bukkit.block.CreakingHeart) this.getObj();
            if (self == null) {
                return Marshal.detached("getCreaking");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.CreakingHeart) self).getCreaking());
            }
            return Marshal.wrongArity("getCreaking", n);
        } catch (Throwable e) {
            return Marshal.failed("getCreaking", e);
        }
    }
    ...
    public AussomType setCreaking(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.CreakingHeart self = (org.bukkit.block.CreakingHeart) this.getObj();
            if (self == null) {
                return Marshal.detached("setCreaking");
            }
            if (n == 1) {
                ((org.bukkit.block.CreakingHeart) self).setCreaking((org.bukkit.entity.Creaking) Marshal.typed(args, 0, org.bukkit.entity.Creaking.class));
                return new AussomNull();
            }
            return Marshal.wrongArity("setCreaking", n);
        } catch (Throwable e) {
            return Marshal.failed("setCreaking", e);
        }
    }
    ...
    public AussomType spawnCreaking(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.CreakingHeart self = (org.bukkit.block.CreakingHeart) this.getObj();
            if (self == null) {
                return Marshal.detached("spawnCreaking");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.CreakingHeart) self).spawnCreaking());
            }
            return Marshal.wrongArity("spawnCreaking", n);
        } catch (Throwable e) {
            return Marshal.failed("spawnCreaking", e);
        }
    }

    public AussomType spreadResin(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.CreakingHeart self = (org.bukkit.block.CreakingHeart) this.getObj();
            if (self == null) {
                return Marshal.detached("spreadResin");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.CreakingHeart) self).spreadResin());
            }
            return Marshal.wrongArity("spreadResin", n);
        } catch (Throwable e) {
            return Marshal.failed("spreadResin", e);
        }
    }
