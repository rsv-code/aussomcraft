...
public class BambooShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Bamboo self = (org.bukkit.block.data.type.Bamboo) this.getObj();
            if (self == null) {
    ...
    public AussomType getLeaves(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Bamboo self = (org.bukkit.block.data.type.Bamboo) this.getObj();
            if (self == null) {
                return Marshal.detached("getLeaves");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Bamboo) self).getLeaves());
            }
            return Marshal.wrongArity("getLeaves", n);
        } catch (Throwable e) {
            return Marshal.failed("getLeaves", e);
        }
    }
    ...
    public AussomType setLeaves(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Bamboo self = (org.bukkit.block.data.type.Bamboo) this.getObj();
            if (self == null) {
                return Marshal.detached("setLeaves");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Bamboo) self).setLeaves((org.bukkit.block.data.type.Bamboo.Leaves) Marshal.typed(args, 0, org.bukkit.block.data.type.Bamboo.Leaves.class));
                return new AussomNull();
            }
            return Marshal.wrongArity("setLeaves", n);
        } catch (Throwable e) {
            return Marshal.failed("setLeaves", e);
        }
    }
