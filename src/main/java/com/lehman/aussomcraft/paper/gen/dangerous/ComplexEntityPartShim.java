...
public class ComplexEntityPartShim extends PaperObj {
    ...
    public AussomType addPassenger(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.entity.ComplexEntityPart self = (org.bukkit.entity.ComplexEntityPart) this.getObj();
            if (self == null) {
    ...
    public AussomType getParent(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.entity.ComplexEntityPart) self).getParent());
            }
