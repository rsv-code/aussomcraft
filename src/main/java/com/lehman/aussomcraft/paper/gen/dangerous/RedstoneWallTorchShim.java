...
public class RedstoneWallTorchShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.RedstoneWallTorch self = (org.bukkit.block.data.type.RedstoneWallTorch) this.getObj();
            if (self == null) {
