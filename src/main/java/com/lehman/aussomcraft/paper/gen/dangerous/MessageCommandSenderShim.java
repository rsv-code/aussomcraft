...
public class MessageCommandSenderShim extends PaperObj {
    ...
    public AussomType clearResourcePacks(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.command.MessageCommandSender self = (org.bukkit.command.MessageCommandSender) this.getObj();
            if (self == null) {
