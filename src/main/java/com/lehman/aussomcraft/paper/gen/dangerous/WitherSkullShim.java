...
public class WitherSkullShim extends PaperObj {
    ...
    public AussomType addPassenger(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.entity.WitherSkull self = (org.bukkit.entity.WitherSkull) this.getObj();
            if (self == null) {
    ...
    public AussomType isCharged(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.entity.WitherSkull) self).isCharged());
            }
    ...
    public AussomType setCharged(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.entity.WitherSkull self = (org.bukkit.entity.WitherSkull) this.getObj();
            if (self == null) {
                return Marshal.detached("setCharged");
            }
            if (n == 1) {
                ((org.bukkit.entity.WitherSkull) self).setCharged(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setCharged", n);
        } catch (Throwable e) {
            return Marshal.failed("setCharged", e);
        }
    }
