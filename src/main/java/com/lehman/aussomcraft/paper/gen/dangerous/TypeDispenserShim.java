...
public class TypeDispenserShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Dispenser self = (org.bukkit.block.data.type.Dispenser) this.getObj();
            if (self == null) {
    ...
    public AussomType isTriggered(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Dispenser) self).isTriggered());
            }
    ...
    public AussomType setTriggered(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.type.Dispenser) self).setTriggered(Marshal.argBool(args, 0));
                return new AussomNull();
            }
