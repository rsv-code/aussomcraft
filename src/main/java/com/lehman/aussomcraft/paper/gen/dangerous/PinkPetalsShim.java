...
public class PinkPetalsShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.PinkPetals self = (org.bukkit.block.data.type.PinkPetals) this.getObj();
            if (self == null) {
    ...
    public AussomType getFlowerAmount(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.PinkPetals self = (org.bukkit.block.data.type.PinkPetals) this.getObj();
            if (self == null) {
                return Marshal.detached("getFlowerAmount");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.FlowerBed) self).getFlowerAmount());
            }
            return Marshal.wrongArity("getFlowerAmount", n);
        } catch (Throwable e) {
            return Marshal.failed("getFlowerAmount", e);
        }
    }
    ...
    public AussomType getMaximumFlowerAmount(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.PinkPetals self = (org.bukkit.block.data.type.PinkPetals) this.getObj();
            if (self == null) {
                return Marshal.detached("getMaximumFlowerAmount");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.FlowerBed) self).getMaximumFlowerAmount());
            }
            return Marshal.wrongArity("getMaximumFlowerAmount", n);
        } catch (Throwable e) {
            return Marshal.failed("getMaximumFlowerAmount", e);
        }
    }

    public AussomType getMinimumFlowerAmount(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.PinkPetals self = (org.bukkit.block.data.type.PinkPetals) this.getObj();
            if (self == null) {
                return Marshal.detached("getMinimumFlowerAmount");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.FlowerBed) self).getMinimumFlowerAmount());
            }
            return Marshal.wrongArity("getMinimumFlowerAmount", n);
        } catch (Throwable e) {
            return Marshal.failed("getMinimumFlowerAmount", e);
        }
    }
    ...
    public AussomType setFlowerAmount(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.PinkPetals self = (org.bukkit.block.data.type.PinkPetals) this.getObj();
            if (self == null) {
                return Marshal.detached("setFlowerAmount");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.FlowerBed) self).setFlowerAmount(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setFlowerAmount", n);
        } catch (Throwable e) {
            return Marshal.failed("setFlowerAmount", e);
        }
    }
