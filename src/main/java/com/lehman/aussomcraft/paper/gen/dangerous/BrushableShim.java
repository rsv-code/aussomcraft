...
public class BrushableShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.Brushable self = (org.bukkit.block.data.Brushable) this.getObj();
            if (self == null) {
    ...
    public AussomType getDusted(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.Brushable self = (org.bukkit.block.data.Brushable) this.getObj();
            if (self == null) {
                return Marshal.detached("getDusted");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.Brushable) self).getDusted());
            }
            return Marshal.wrongArity("getDusted", n);
        } catch (Throwable e) {
            return Marshal.failed("getDusted", e);
        }
    }
    ...
    public AussomType getMaximumDusted(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.Brushable self = (org.bukkit.block.data.Brushable) this.getObj();
            if (self == null) {
                return Marshal.detached("getMaximumDusted");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.Brushable) self).getMaximumDusted());
            }
            return Marshal.wrongArity("getMaximumDusted", n);
        } catch (Throwable e) {
            return Marshal.failed("getMaximumDusted", e);
        }
    }
    ...
    public AussomType setDusted(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.Brushable self = (org.bukkit.block.data.Brushable) this.getObj();
            if (self == null) {
                return Marshal.detached("setDusted");
            }
            if (n == 1) {
                ((org.bukkit.block.data.Brushable) self).setDusted(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setDusted", n);
        } catch (Throwable e) {
            return Marshal.failed("setDusted", e);
        }
    }
