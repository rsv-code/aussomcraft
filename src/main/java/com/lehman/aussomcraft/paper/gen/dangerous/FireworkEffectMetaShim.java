...
public class FireworkEffectMetaShim extends PaperObj {
    ...
    public AussomType addAttributeModifier(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.inventory.meta.FireworkEffectMeta self = (org.bukkit.inventory.meta.FireworkEffectMeta) this.getObj();
            if (self == null) {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.inventory.meta.FireworkEffectMeta) self).clone());
            }
    ...
    public AussomType getEffect(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.inventory.meta.FireworkEffectMeta) self).getEffect());
            }
    ...
    public AussomType hasEffect(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.inventory.meta.FireworkEffectMeta self = (org.bukkit.inventory.meta.FireworkEffectMeta) this.getObj();
            if (self == null) {
                return Marshal.detached("hasEffect");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.inventory.meta.FireworkEffectMeta) self).hasEffect());
            }
            return Marshal.wrongArity("hasEffect", n);
        } catch (Throwable e) {
            return Marshal.failed("hasEffect", e);
        }
    }
    ...
    public AussomType setEffect(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.inventory.meta.FireworkEffectMeta) self).setEffect((org.bukkit.FireworkEffect) Marshal.typed(args, 0, org.bukkit.FireworkEffect.class));
                return new AussomNull();
            }
