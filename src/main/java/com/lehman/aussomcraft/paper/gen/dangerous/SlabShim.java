...
public class SlabShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Slab self = (org.bukkit.block.data.type.Slab) this.getObj();
            if (self == null) {
    ...
    public AussomType getType(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Slab) self).getType());
            }
    ...
    public AussomType setType(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.type.Slab) self).setType((org.bukkit.block.data.type.Slab.Type) Marshal.typed(args, 0, org.bukkit.block.data.type.Slab.Type.class));
                return new AussomNull();
            }
