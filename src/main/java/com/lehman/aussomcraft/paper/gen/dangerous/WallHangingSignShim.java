...
public class WallHangingSignShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.WallHangingSign self = (org.bukkit.block.data.type.WallHangingSign) this.getObj();
            if (self == null) {
