...
public class SculkShriekerShim extends PaperObj {
    ...
    public AussomType copy(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.SculkShrieker self = (org.bukkit.block.SculkShrieker) this.getObj();
            if (self == null) {
    ...
    public AussomType getWarningLevel(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.SculkShrieker self = (org.bukkit.block.SculkShrieker) this.getObj();
            if (self == null) {
                return Marshal.detached("getWarningLevel");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.SculkShrieker) self).getWarningLevel());
            }
            return Marshal.wrongArity("getWarningLevel", n);
        } catch (Throwable e) {
            return Marshal.failed("getWarningLevel", e);
        }
    }
    ...
    public AussomType setWarningLevel(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.SculkShrieker self = (org.bukkit.block.SculkShrieker) this.getObj();
            if (self == null) {
                return Marshal.detached("setWarningLevel");
            }
            if (n == 1) {
                ((org.bukkit.block.SculkShrieker) self).setWarningLevel(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setWarningLevel", n);
        } catch (Throwable e) {
            return Marshal.failed("setWarningLevel", e);
        }
    }

    public AussomType tryShriek(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.SculkShrieker self = (org.bukkit.block.SculkShrieker) this.getObj();
            if (self == null) {
                return Marshal.detached("tryShriek");
            }
            if (n == 1) {
                ((org.bukkit.block.SculkShrieker) self).tryShriek((org.bukkit.entity.Player) Marshal.typed(args, 0, org.bukkit.entity.Player.class));
                return new AussomNull();
            }
            return Marshal.wrongArity("tryShriek", n);
        } catch (Throwable e) {
            return Marshal.failed("tryShriek", e);
        }
    }
