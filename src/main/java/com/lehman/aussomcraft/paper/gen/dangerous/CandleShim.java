...
public class CandleShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Candle self = (org.bukkit.block.data.type.Candle) this.getObj();
            if (self == null) {
    ...
    public AussomType getCandles(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Candle self = (org.bukkit.block.data.type.Candle) this.getObj();
            if (self == null) {
                return Marshal.detached("getCandles");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Candle) self).getCandles());
            }
            return Marshal.wrongArity("getCandles", n);
        } catch (Throwable e) {
            return Marshal.failed("getCandles", e);
        }
    }
    ...
    public AussomType getMaximumCandles(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Candle self = (org.bukkit.block.data.type.Candle) this.getObj();
            if (self == null) {
                return Marshal.detached("getMaximumCandles");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Candle) self).getMaximumCandles());
            }
            return Marshal.wrongArity("getMaximumCandles", n);
        } catch (Throwable e) {
            return Marshal.failed("getMaximumCandles", e);
        }
    }

    public AussomType getMinimumCandles(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Candle self = (org.bukkit.block.data.type.Candle) this.getObj();
            if (self == null) {
                return Marshal.detached("getMinimumCandles");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Candle) self).getMinimumCandles());
            }
            return Marshal.wrongArity("getMinimumCandles", n);
        } catch (Throwable e) {
            return Marshal.failed("getMinimumCandles", e);
        }
    }
    ...
    public AussomType setCandles(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Candle self = (org.bukkit.block.data.type.Candle) this.getObj();
            if (self == null) {
                return Marshal.detached("setCandles");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Candle) self).setCandles(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setCandles", n);
        } catch (Throwable e) {
            return Marshal.failed("setCandles", e);
        }
    }
