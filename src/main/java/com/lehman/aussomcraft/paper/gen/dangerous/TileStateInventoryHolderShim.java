...
public class TileStateInventoryHolderShim extends PaperObj {
    ...
    public AussomType copy(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            io.papermc.paper.block.TileStateInventoryHolder self = (io.papermc.paper.block.TileStateInventoryHolder) this.getObj();
            if (self == null) {
