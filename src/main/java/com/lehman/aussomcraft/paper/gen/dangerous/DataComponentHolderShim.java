...
public class DataComponentHolderShim extends PaperObj {
    ...
    public AussomType getData(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            io.papermc.paper.datacomponent.DataComponentHolder self = (io.papermc.paper.datacomponent.DataComponentHolder) this.getObj();
            if (self == null) {
