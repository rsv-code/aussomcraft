...
public class SnowableShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.Snowable self = (org.bukkit.block.data.Snowable) this.getObj();
            if (self == null) {
    ...
    public AussomType isSnowy(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.Snowable self = (org.bukkit.block.data.Snowable) this.getObj();
            if (self == null) {
                return Marshal.detached("isSnowy");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.Snowable) self).isSnowy());
            }
            return Marshal.wrongArity("isSnowy", n);
        } catch (Throwable e) {
            return Marshal.failed("isSnowy", e);
        }
    }
    ...
    public AussomType setSnowy(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.Snowable self = (org.bukkit.block.data.Snowable) this.getObj();
            if (self == null) {
                return Marshal.detached("setSnowy");
            }
            if (n == 1) {
                ((org.bukkit.block.data.Snowable) self).setSnowy(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setSnowy", n);
        } catch (Throwable e) {
            return Marshal.failed("setSnowy", e);
        }
    }
