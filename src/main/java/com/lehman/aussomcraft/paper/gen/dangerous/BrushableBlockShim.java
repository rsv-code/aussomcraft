...
public class BrushableBlockShim extends PaperObj {
    ...
    public AussomType clearLootTable(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.BrushableBlock self = (org.bukkit.block.BrushableBlock) this.getObj();
            if (self == null) {
    ...
    public AussomType getItem(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.BrushableBlock) self).getItem());
            }
    ...
    public AussomType setItem(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.BrushableBlock) self).setItem((org.bukkit.inventory.ItemStack) Marshal.typed(args, 0, org.bukkit.inventory.ItemStack.class));
                return new AussomNull();
            }
