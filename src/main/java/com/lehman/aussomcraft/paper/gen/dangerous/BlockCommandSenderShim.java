...
public class BlockCommandSenderShim extends PaperObj {
    ...
    public AussomType clearResourcePacks(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.command.BlockCommandSender self = (org.bukkit.command.BlockCommandSender) this.getObj();
            if (self == null) {
    ...
    public AussomType getBlock(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.command.BlockCommandSender) self).getBlock());
            }
