...
public class BubbleColumnShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.BubbleColumn self = (org.bukkit.block.data.type.BubbleColumn) this.getObj();
            if (self == null) {
    ...
    public AussomType isDrag(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.BubbleColumn self = (org.bukkit.block.data.type.BubbleColumn) this.getObj();
            if (self == null) {
                return Marshal.detached("isDrag");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.BubbleColumn) self).isDrag());
            }
            return Marshal.wrongArity("isDrag", n);
        } catch (Throwable e) {
            return Marshal.failed("isDrag", e);
        }
    }
    ...
    public AussomType setDrag(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.BubbleColumn self = (org.bukkit.block.data.type.BubbleColumn) this.getObj();
            if (self == null) {
                return Marshal.detached("setDrag");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.BubbleColumn) self).setDrag(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setDrag", n);
        } catch (Throwable e) {
            return Marshal.failed("setDrag", e);
        }
    }
