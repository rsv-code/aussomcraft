...
public class TypeJukeboxShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Jukebox self = (org.bukkit.block.data.type.Jukebox) this.getObj();
            if (self == null) {
    ...
    public AussomType hasRecord(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Jukebox) self).hasRecord());
            }
    ...
    public AussomType setHasRecord(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Jukebox self = (org.bukkit.block.data.type.Jukebox) this.getObj();
            if (self == null) {
                return Marshal.detached("setHasRecord");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Jukebox) self).setHasRecord(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setHasRecord", n);
        } catch (Throwable e) {
            return Marshal.failed("setHasRecord", e);
        }
    }
