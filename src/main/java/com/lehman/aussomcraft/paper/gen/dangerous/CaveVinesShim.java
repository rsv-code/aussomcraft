...
public class CaveVinesShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.CaveVines self = (org.bukkit.block.data.type.CaveVines) this.getObj();
            if (self == null) {
    ...
    public AussomType hasBerries(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.CaveVines self = (org.bukkit.block.data.type.CaveVines) this.getObj();
            if (self == null) {
                return Marshal.detached("hasBerries");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.CaveVinesPlant) self).hasBerries());
            }
            return Marshal.wrongArity("hasBerries", n);
        } catch (Throwable e) {
            return Marshal.failed("hasBerries", e);
        }
    }

    public AussomType isBerries(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.CaveVines self = (org.bukkit.block.data.type.CaveVines) this.getObj();
            if (self == null) {
                return Marshal.detached("isBerries");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.CaveVinesPlant) self).isBerries());
            }
            return Marshal.wrongArity("isBerries", n);
        } catch (Throwable e) {
            return Marshal.failed("isBerries", e);
        }
    }
    ...
    public AussomType setBerries(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.CaveVines self = (org.bukkit.block.data.type.CaveVines) this.getObj();
            if (self == null) {
                return Marshal.detached("setBerries");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.CaveVinesPlant) self).setBerries(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setBerries", n);
        } catch (Throwable e) {
            return Marshal.failed("setBerries", e);
        }
    }
