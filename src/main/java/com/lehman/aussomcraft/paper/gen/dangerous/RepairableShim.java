...
public class RepairableShim extends PaperObj {
    ...
    public AussomType addAttributeModifier(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.inventory.meta.Repairable self = (org.bukkit.inventory.meta.Repairable) this.getObj();
            if (self == null) {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.inventory.meta.Repairable) self).clone());
            }
    ...
    public AussomType getRepairCost(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.inventory.meta.Repairable) self).getRepairCost());
            }
    ...
    public AussomType hasRepairCost(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.inventory.meta.Repairable self = (org.bukkit.inventory.meta.Repairable) this.getObj();
            if (self == null) {
                return Marshal.detached("hasRepairCost");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.inventory.meta.Repairable) self).hasRepairCost());
            }
            return Marshal.wrongArity("hasRepairCost", n);
        } catch (Throwable e) {
            return Marshal.failed("hasRepairCost", e);
        }
    }
    ...
    public AussomType setRepairCost(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.inventory.meta.Repairable) self).setRepairCost(Marshal.argInt(args, 0));
                return new AussomNull();
            }
