...
public class LeafLitterShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.LeafLitter self = (org.bukkit.block.data.type.LeafLitter) this.getObj();
            if (self == null) {
    ...
    public AussomType getMaximumSegmentAmount(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.LeafLitter self = (org.bukkit.block.data.type.LeafLitter) this.getObj();
            if (self == null) {
                return Marshal.detached("getMaximumSegmentAmount");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.Segmentable) self).getMaximumSegmentAmount());
            }
            return Marshal.wrongArity("getMaximumSegmentAmount", n);
        } catch (Throwable e) {
            return Marshal.failed("getMaximumSegmentAmount", e);
        }
    }

    public AussomType getMinimumSegmentAmount(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.LeafLitter self = (org.bukkit.block.data.type.LeafLitter) this.getObj();
            if (self == null) {
                return Marshal.detached("getMinimumSegmentAmount");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.Segmentable) self).getMinimumSegmentAmount());
            }
            return Marshal.wrongArity("getMinimumSegmentAmount", n);
        } catch (Throwable e) {
            return Marshal.failed("getMinimumSegmentAmount", e);
        }
    }
    ...
    public AussomType getSegmentAmount(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.LeafLitter self = (org.bukkit.block.data.type.LeafLitter) this.getObj();
            if (self == null) {
                return Marshal.detached("getSegmentAmount");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.Segmentable) self).getSegmentAmount());
            }
            return Marshal.wrongArity("getSegmentAmount", n);
        } catch (Throwable e) {
            return Marshal.failed("getSegmentAmount", e);
        }
    }
    ...
    public AussomType setSegmentAmount(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.LeafLitter self = (org.bukkit.block.data.type.LeafLitter) this.getObj();
            if (self == null) {
                return Marshal.detached("setSegmentAmount");
            }
            if (n == 1) {
                ((org.bukkit.block.data.Segmentable) self).setSegmentAmount(Marshal.argInt(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setSegmentAmount", n);
        } catch (Throwable e) {
            return Marshal.failed("setSegmentAmount", e);
        }
    }
