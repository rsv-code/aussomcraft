...
public class ShulkerBoxShim extends PaperObj {
    ...
    public AussomType canPlayerLoot(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.ShulkerBox self = (org.bukkit.block.ShulkerBox) this.getObj();
            if (self == null) {
    ...
    public AussomType getColor(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.ShulkerBox) self).getColor());
            }
