...
public class LightShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Light self = (org.bukkit.block.data.type.Light) this.getObj();
            if (self == null) {
    ...
    public AussomType getLevel(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.Levelled) self).getLevel());
            }
    ...
    public AussomType getMaximumLevel(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Light self = (org.bukkit.block.data.type.Light) this.getObj();
            if (self == null) {
                return Marshal.detached("getMaximumLevel");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.Levelled) self).getMaximumLevel());
            }
            return Marshal.wrongArity("getMaximumLevel", n);
        } catch (Throwable e) {
            return Marshal.failed("getMaximumLevel", e);
        }
    }

    public AussomType getMinimumLevel(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Light self = (org.bukkit.block.data.type.Light) this.getObj();
            if (self == null) {
                return Marshal.detached("getMinimumLevel");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.Levelled) self).getMinimumLevel());
            }
            return Marshal.wrongArity("getMinimumLevel", n);
        } catch (Throwable e) {
            return Marshal.failed("getMinimumLevel", e);
        }
    }
    ...
    public AussomType setLevel(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 1) {
                ((org.bukkit.block.data.Levelled) self).setLevel(Marshal.argInt(args, 0));
                return new AussomNull();
            }
