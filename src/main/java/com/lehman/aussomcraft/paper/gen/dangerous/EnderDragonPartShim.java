...
public class EnderDragonPartShim extends PaperObj {
    ...
    public AussomType addPassenger(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.entity.EnderDragonPart self = (org.bukkit.entity.EnderDragonPart) this.getObj();
            if (self == null) {
    ...
    public AussomType getParent(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            ...
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.entity.EnderDragonPart) self).getParent());
            }
