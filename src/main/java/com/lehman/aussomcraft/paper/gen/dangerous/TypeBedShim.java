...
public class TypeBedShim extends PaperObj {
    ...
    public AussomType clone(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.data.type.Bed self = (org.bukkit.block.data.type.Bed) this.getObj();
            if (self == null) {
    ...
    public AussomType getPart(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Bed self = (org.bukkit.block.data.type.Bed) this.getObj();
            if (self == null) {
                return Marshal.detached("getPart");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Bed) self).getPart());
            }
            return Marshal.wrongArity("getPart", n);
        } catch (Throwable e) {
            return Marshal.failed("getPart", e);
        }
    }
    ...
    public AussomType isOccupied(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Bed self = (org.bukkit.block.data.type.Bed) this.getObj();
            if (self == null) {
                return Marshal.detached("isOccupied");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.data.type.Bed) self).isOccupied());
            }
            return Marshal.wrongArity("isOccupied", n);
        } catch (Throwable e) {
            return Marshal.failed("isOccupied", e);
        }
    }
    ...
    public AussomType setOccupied(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Bed self = (org.bukkit.block.data.type.Bed) this.getObj();
            if (self == null) {
                return Marshal.detached("setOccupied");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Bed) self).setOccupied(Marshal.argBool(args, 0));
                return new AussomNull();
            }
            return Marshal.wrongArity("setOccupied", n);
        } catch (Throwable e) {
            return Marshal.failed("setOccupied", e);
        }
    }

    public AussomType setPart(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.data.type.Bed self = (org.bukkit.block.data.type.Bed) this.getObj();
            if (self == null) {
                return Marshal.detached("setPart");
            }
            if (n == 1) {
                ((org.bukkit.block.data.type.Bed) self).setPart((org.bukkit.block.data.type.Bed.Part) Marshal.typed(args, 0, org.bukkit.block.data.type.Bed.Part.class));
                return new AussomNull();
            }
            return Marshal.wrongArity("setPart", n);
        } catch (Throwable e) {
            return Marshal.failed("setPart", e);
        }
    }
