...
public class ChestShim extends PaperObj {
    ...
    public AussomType canPlayerLoot(Environment env, ArrayList<AussomType> args) {
        ...
        try {
            org.bukkit.block.Chest self = (org.bukkit.block.Chest) this.getObj();
            if (self == null) {
    ...
    public AussomType getBlockInventory(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.Chest self = (org.bukkit.block.Chest) this.getObj();
            if (self == null) {
                return Marshal.detached("getBlockInventory");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.Chest) self).getBlockInventory());
            }
            return Marshal.wrongArity("getBlockInventory", n);
        } catch (Throwable e) {
            return Marshal.failed("getBlockInventory", e);
        }
    }
    ...
    public AussomType isBlocked(Environment env, ArrayList<AussomType> args) {
        int n = 0;
        if (args != null) {
            n = args.size();
        }
        try {
            org.bukkit.block.Chest self = (org.bukkit.block.Chest) this.getObj();
            if (self == null) {
                return Marshal.detached("isBlocked");
            }
            if (n == 0) {
                return Marshal.wrap(env, ((org.bukkit.block.Chest) self).isBlocked());
            }
            return Marshal.wrongArity("isBlocked", n);
        } catch (Throwable e) {
            return Marshal.failed("isBlocked", e);
        }
    }
